...
internal class AspectRatioImageView @JvmOverloads constructor(
    ...
    init {
        ...
        aspectRatio = a.getFloat(
            R.styleable.AspectRatioImageView_gd_aspectRatio,
            DEFAULT_ASPECT_RATIO
        )
        aspectRatioEnabled = a.getBoolean(
            R.styleable.AspectRatioImageView_gd_aspectRatioEnabled,
            DEFAULT_ASPECT_RATIO_ENABLED
        )
        dominantMeasurement = a.getInt(
            R.styleable.AspectRatioImageView_gd_dominantMeasurement,
