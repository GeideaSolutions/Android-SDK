...
internal constructor(
    ...
    override fun toString(): String {
        return "InstallmentPlanSelectedResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language, orderId=$orderId, nextStep=$nextStep)"
    }
