...
internal constructor(
        ...
        val htmlBodyContent: String? = null,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (htmlBodyContent != other.htmlBodyContent) return false
    ...
    override fun toString(): String {
        return "AuthenticationResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language, orderId=$orderId, threeDSecureId=$threeDSecureId, htmlBodyContent='$htmlBodyContent', gatewayDecision=$gatewayDecision)"
    }

    companion object {
        @JvmStatic
        fun fromJson(json: String): AuthenticationResponse = decodeFromJson(json)
    }
}