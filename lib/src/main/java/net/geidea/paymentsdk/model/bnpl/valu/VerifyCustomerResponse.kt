...
internal constructor(
    ...
    override fun toString(): String {
        return "VerifyCustomerResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language)"
    }
