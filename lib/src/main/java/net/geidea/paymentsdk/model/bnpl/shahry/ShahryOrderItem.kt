...
@Parcelize
@Serializable
class ShahryOrderItem private constructor(
    ...
    override fun toString(): String {
        return "ShahryOrderItem(merchantItemId=$merchantItemId, name=$name, description=$description, categories=$categories, count=$count, price=$price, currency=$currency)"
    }
    ...
    class Builder {
        ...
        fun setCategories(categories: List<String>?): Builder = apply { this.categories = categories }
        ...
        fun build(): ShahryOrderItem {
            return ShahryOrderItem(
...
fun ShahryOrderItem(initializer: ShahryOrderItem.Builder.() -> Unit): ShahryOrderItem {
    return ShahryOrderItem.Builder().apply(initializer).build()
}

@GeideaSdkInternal
internal fun List<OrderItem>.toShahryOrderItems(currency: String): List<ShahryOrderItem> {
    return map {
        ShahryOrderItem {
