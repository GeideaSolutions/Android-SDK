...
@Parcelize
@Serializable
class EInvoiceOrdersResponse

@GeideaSdkInternal
internal constructor(
    val paymentIntent: EInvoicePaymentIntent? = null,
...
) : GeideaResponse, GeideaJsonObject {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as EInvoiceOrdersResponse
    ...
    override fun toString(): String {
        return "EInvoiceOrdersResponse(paymentIntent=$paymentIntent, responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language)"
    }

    companion object {
        @JvmStatic
        fun fromJson(json: String): EInvoiceOrdersResponse = decodeFromJson(json)
    }
}