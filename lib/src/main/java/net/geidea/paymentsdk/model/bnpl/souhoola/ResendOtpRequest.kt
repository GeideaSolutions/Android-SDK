...
@Serializable
class ResendOtpRequest constructor(
    ...
    override fun toString(): String {
        return "ResendOtpRequest(language=$language, customerIdentifier='$customerIdentifier', customerPin='$customerPin')"
    }

    companion object {
        @JvmStatic
        fun fromJson(json: String): ResendOtpRequest = decodeFromJson(json)
    }
}