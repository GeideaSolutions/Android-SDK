...
internal constructor(
    ...
    override fun toString(): String {
        return "ResendOtpResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language)"
    }


    companion object {
        @JvmStatic
        fun fromJson(json: String): ResendOtpResponse = decodeFromJson(json)
    }
}