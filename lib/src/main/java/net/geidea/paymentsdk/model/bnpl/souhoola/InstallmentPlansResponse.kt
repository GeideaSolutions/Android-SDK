...
internal constructor(
    ...
    override fun toString(): String {
        return "InstallmentPlansResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language, currency='$currency', minimumDownPayment=$minimumDownPayment, bnplOrderId=$bnplOrderId, installmentPlans=$installmentPlans)"
    }
