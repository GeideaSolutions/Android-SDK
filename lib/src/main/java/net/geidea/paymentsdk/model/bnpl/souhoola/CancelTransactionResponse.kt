...
internal constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        other as CancelTransactionResponse
    ...
    override fun toString(): String {
        return "CancelTransactionResponse(responseCode=$responseCode, responseMessage=$responseMessage, detailedResponseCode=$detailedResponseCode, detailedResponseMessage=$detailedResponseMessage, language=$language)"
    }


    companion object {
        @JvmStatic
        fun fromJson(json: String): CancelTransactionResponse = decodeFromJson(json)
    }
}